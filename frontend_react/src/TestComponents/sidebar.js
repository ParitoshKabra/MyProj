...
export class Sidebar extends React.Component {
	...
	render() {
		return (
			<List
				sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper', display:"flex", flexDirection:"column", border: "2px solid black"}}
				component="nav"
			...
			>
                ...
                <Collapse in={this.state.open} timeout="auto" unmountOnExit>
					<List component="div">
						<ListItem sx={{ pl: 4 }}>
							<ProjectTemplate {...this.props} projects={this.props.user['projects_of_user']} setAsActive={this.setAsActive} />
						</ListItem>
					</List>
				</Collapse>
